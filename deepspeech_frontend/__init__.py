...
if os.path.isfile("models/deepspeech-0.7.3-models.pbmm"):
    print("Starting the DeepSpeech Frontend")
    ds = Model('models/deepspeech-0.7.3-models.pbmm')
    ds.enableExternalScorer('models/deepspeech-0.7.3-models.scorer')
elif os.path.isfile("/var/lib/deepspeech/models/deepspeech-0.7.3-models.pbmm"):
    ds = Model('/var/lib/deepspeech/models/deepspeech-0.7.3-models.pbmm')
    ds.enableExternalScorer('/var/lib/deepspeech/models/deepspeech-0.7.3-models.scorer')
else:
